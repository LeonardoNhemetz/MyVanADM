...
/**
 * Created by Leonardo on 07/12/2016.
 */

public class RouteIR extends AsyncTask<String, Void, String> {
    ...
    public void drawRoute() {
        ...
        if (polyline == null) {
            ...
            polyline = MapsIR.map.addPolyline(po);
        } else {
