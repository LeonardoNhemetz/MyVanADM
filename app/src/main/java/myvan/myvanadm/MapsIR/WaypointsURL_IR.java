...
public class WaypointsURL_IR extends AsyncTask<Void, Void, String> {

    private static final String LOG_TAG = "ExampleApp";

    private static final String SERVICE_URL = "http://35.231.239.84/myvan/ADM/MapsIR.php";
    ...
    public WaypointsURL_IR(Context context) {
    ...
    protected void onPostExecute(String json) {
        ...
        try
        {
            ...
            for (int i = 0; i <= jsonArray.length(); i++)
            {
                ...
                String status = (jsonObj.getString("status_ir_pass"));
                ...
                if(status.equals("sim"))
                {
                    ...
                    MapsIR.map.addMarker(new MarkerOptions()
        ...
        waypoints.toString();
        String origin = getset.getEndOri()+","+getset.getNumOri()+","+getset.getCidOri();
        String dest = getset.getEndDest()+","+getset.getNumDest()+","+getset.getCidDest();
        ...
        RouteIR routeIR = new RouteIR(context);
        routeIR.execute(url);
