...
public class BackgroundInsert extends AsyncTask <String,Void,String> {
    ...
    {
        String reg_url = "http://35.231.239.84/myvan/ADM/register.php";
        ...
        if(type.equals("Register"))
        {
            ...
            String login_user = params[17];
            String pass_user = params[18];
            ...
            try
            {
                ...
                String data = URLEncoder.encode("nome_pass","UTF-8")+"="+URLEncoder.encode(nome_pass,"UTF-8")+"&"+
